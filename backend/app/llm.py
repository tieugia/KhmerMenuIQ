...
def answer_general_question(
    ...
    system = (
        ...
        "If the diner asks whether it is a good choice, asks for a recommendation, or asks for a "
        "comparison, compare its exact price with at least two relevant alternatives from "
        "matching_menu_items. Prefer items marked as the same category, name the alternatives and "
        "their prices, and use the precomputed price_vs_selected/price_difference_usd fields instead "
        "of doing arithmetic yourself. Explain value only from known menu facts (category and price); "
        "do not infer taste, portion size, ingredients, or quality. "
